...
public class unassignedTickets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor=unassignedTickets.tikt_db.ticketsdao().getAll(status);
        ...
        n=unassignedTickets.tikt_db.ticketsdao().getCount("unassigned");
        ...
        for(int i=0;i<n && (!cursor.isAfterLast());i++){
            ...
            c[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i=new Intent(unassignedTickets.this,closedTickets1.class);
