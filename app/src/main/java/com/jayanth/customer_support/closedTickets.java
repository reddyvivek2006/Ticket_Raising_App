...
public class closedTickets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = closedTickets.tikt_db.ticketsdao().getAll(status);
        ...
        n = closedTickets.tikt_db.ticketsdao().getCount("unassigned");
        ...
        for (int i = 0; i < n && (!cursor.isAfterLast()); i++) {
            ...
            c[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i=new Intent(closedTickets.this,closedTickets1.class);
